...
const stagger = { animate: { transition: { staggerChildren: 0.6, delayChildren: 0.3 } } };
      ...
      <div style={{ flex: 1, maxWidth: 520, paddingRight: 48, position: "relative", zIndex: 10 }}>
        <motion.div variants={stagger} initial="initial" animate="animate">
          ...
          <motion.div
            variants={{
              initial: { opacity: 0 },
              animate: { opacity: 1, transition: { staggerChildren: 0.05, delayChildren: 0.6 } },
            }}
            initial="initial"
            animate="animate"
            style={{ fontSize: 17, color: "#94a3b8", lineHeight: 1.7, marginBottom: 32, display: "inline-block" }}
          >
            {[
              { text: "Banks handle " },
              { text: "10M+ complaints", bold: true, highlight: "#f8fafc" },
              { text: " annually across disconnected channels. Complaints get lost, angry customers are treated like normal ones, and delays lead to " },
              { text: "penalties and lost trust", bold: true, highlight: "#ef4444" },
              { text: "." },
            ].map((segment, idx) => (
              <span
                key={idx}
                style={{
                  color: segment.highlight || "inherit",
