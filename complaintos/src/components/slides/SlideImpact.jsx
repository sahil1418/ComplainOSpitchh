        ...
        <div className="grid grid-cols-4 gap-6 w-full max-w-5xl">
          {kpis.map(({ icon: Icon, label, before, after, suffix, prefix, decimals, color, bgColor, borderColor, change, description }, i) => (
            <motion.div
              ...
              transition={{ delay: 0.8 + i * 0.8, duration: 0.6, ease: [0.25, 0.46, 0.45, 0.94] }}
              ...
              >
                ...
                <div className="flex justify-center mb-4">
                  <motion.div
                    initial={{ scale: 0 }}
                    animate={{ scale: 1 }}
                    transition={{ delay: 1.0 + i * 0.8, duration: 0.4, type: "spring" }}
                ...
                <motion.div
                  ...
                  transition={{ delay: 1.8 + i * 0.8, duration: 0.4 }}
